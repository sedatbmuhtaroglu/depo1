...
```bash
PHASE_INFO=$(node "C:/Users/MONSTER/Desktop/MENUCY/qrmenu-order/.cursor/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "C:/Users/MONSTER/Desktop/MENUCY/qrmenu-order/.cursor/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}" --pick found)
...
```bash
PHASE_DIR=$(node "C:/Users/MONSTER/Desktop/MENUCY/qrmenu-order/.cursor/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
